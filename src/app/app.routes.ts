...
export const routes: Routes = [
    { path: 'login', component: LoginComponent },
    {
        ...
        children: [
            ...
            { path: 'relationships/new', loadComponent: () => import('./features/relationships/relationship-editor/relationship-editor.component').then(m => m.RelationshipEditorComponent) },
            { path: 'relationships/:id', loadComponent: () => import('./features/relationships/relationship-editor/relationship-editor.component').then(m => m.RelationshipEditorComponent) },
            { path: 'relationships/:id/edit', loadComponent: () => import('./features/relationships/relationship-editor/relationship-editor.component').then(m => m.RelationshipEditorComponent) },
